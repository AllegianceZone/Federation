...
-- Imago 10/14 create rule ZeroToOne as @Z >=0 AND @Z <=1
-- Imago 10/14 create rule PercentByte as @P >= 0 AND @P <= 100
...
-- Imago 10/14 exec profile.profile.dbo.p_grant_petitions_aleg @SquadID, @MemberID, @ErrorCode output, @ErrorMsg output
...
-- Imago 10/14 exec profile.profile.dbo.p_petition_team_aleg @SquadID, @MemberID, @ErrorCode output, @ErrorMsg output
